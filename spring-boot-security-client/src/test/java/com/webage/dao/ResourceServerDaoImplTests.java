...
//  PART 17a -
@TestPropertySource(properties = "authorization.server.port=8000")
public class ResourceServerDaoImplTests {
    ...
    //  PART17b -
    //  Add the @Autowired annotation to the ResourceServerDao member variable:

    @Autowired ResourceServerDao client;
    ...
    @Value("${resource.server.port}") int wiremockPort;

    @BeforeEach
    public void setup() {

        //  PART 17c - 
        //  Add three lines of code to the @BeforeEach method to 
        //  create, start, and configure the wireMockServer with the selected port:
        ...
        //  PART 17d - 
        //  Review the stubFor() code below.  The mock will expect a GET call 
        //  to /purchases passing a bearer token, and will respond by returning some JSON data: 
